Feature: E2E Checkout Journeys
    ...
    Scenario: To verify order created sucessfully for two products without login from Products details page
        When A user Navigate to "Women" and "Tops"
        ...
        When A user Navigate to "Women" and "Bottoms"
        And I view the product detail "Erika Running Short"
        And I select size "28" and color "Green" and quantity "3" in product details page
        ...
        |false   |checkout@gmail.com|Danny    |Morrision|Balmer |walsal     |North street|1st floor  |Florida|Alaska|64530   |United States|9876543201  |
        Then Order should be created successfully

    Scenario: To verify order created sucessfully for two products with login from Products details page
	    When I logged in with username "checkout@gmail.com" and password "Checkout!123"
